...
@Component({
  selector: 'dwu-image-stream-classifiers-editor',
  templateUrl: './image-stream-classifiers-editor.component.html',
  styleUrls: ['./image-stream-classifiers-editor.component.scss']
})
export class ImageStreamClassifiersEditorComponent {
